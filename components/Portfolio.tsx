...
//   // Track which card is active on mobile/tablet
...
//   // Function to toggle card info display for mobile/tablet
...
//           opacity: isMounted ? 1 : scrollOpacity,
//         }}
//         className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pt-20 z-10 justify-items-center"
//       >
//         {projects.map((project, index) => (
//           <motion.div
//             key={project.title}
...
//             viewport={{ once: true, margin: "-50px" }}
//             className={`relative w-[250px] h-[250px] overflow-hidden mx-auto ${
//               !isDesktop ? "cursor-pointer" : "group"
//             }`}
//             onClick={() => !isDesktop && toggleCardInfo(index)}
//           >
//             {/* Square image container */}
//             <div className="w-full h-full">
//               <Image
...
//             {/* Overlay content - different behavior based on screen size */}
//             <div
//               className={`absolute inset-0 flex flex-col justify-end p-6 bg-black/90 transition-transform duration-300 ease-out
//                 ${
//                   isDesktop
//                     ? "transform translate-y-full group-hover:translate-y-0" // Desktop hover behavior
//                     : activeCardIndex === index
//                     ? "transform translate-y-0" // Mobile/tablet - showing when active
//                     : "transform translate-y-full" // Mobile/tablet - hidden when not active
//                 }`}
//             >
//               <h3 className="text-2xl font-bold mb-2 text-[#B8860B]">
//                 {project.title}
